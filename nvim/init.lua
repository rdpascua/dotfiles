...
vim.keymap.set('n', '<leader>pv', '<Cmd>Neotree toggle reveal<CR>', { desc = 'NeoTree' })
vim.keymap.set('n', '<leader>ce', function()
  local new_file = vim.fn.input('Copy to: ', vim.fn.expand '%:p:h/', 'file')
  if new_file ~= '' then
    vim.cmd('write! ' .. new_file)
    print('File copied to: ' .. new_file)
  end
end, { desc = '[C]opy [E]lement or File' })

vim.keymap.set('n', '<leader>re', function()
  local current_file = vim.fn.expand '%:p'
  local new_file = vim.fn.input('Rename to: ', vim.fn.expand '%:p:h/', 'file')
  if new_file ~= '' and new_file ~= current_file then
    vim.cmd('silent !mv ' .. vim.fn.shellescape(current_file) .. ' ' .. vim.fn.shellescape(new_file))
    vim.cmd('e ' .. new_file)
    print('File renamed to: ' .. new_file)
  end
end, { desc = '[R]ename [E]lement or File' })
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = {
        'bash', 'c', 'css', 'go', 'gomod', 'gosum', 'html', 'javascript',
        'json', 'kotlin', 'lua', 'markdown', 'markdown_inline', 'php',
